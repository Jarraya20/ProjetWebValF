...
<head>
    ...
    <title>Modifier Etat Reclamation| Kalthita</title>
    ...
    <?PHP
          ...
          include "../core/reclamationC.php";
            ...
            $reclamationC=new reclamationC();
              $result=$reclamationC->recupererReclamation($_GET['ref']);
        ...
        <div class="single-product-tab-area mg-tb-15">
            ...
            <div class="single-pro-review-area">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        -<input value="<?php echo $etat ?>" name="etat" type="text" class="form-control" placeholder="Etat"> 
                                                    </div>
                ...
                if (isset($_POST['modifier'])){
                  $rec=new rec("","","","","",$_POST['etat']);
                    $reclamationC->modifierEtat($rec,$_POST['ref_ini']);
